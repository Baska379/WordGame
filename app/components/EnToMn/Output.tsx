...
const Output = () => {
  ...
  const inputStyle: string =
    "bg-slate-900/30 relative font-bold  px-[0.5rem] shadow-[0_0_5px_1px_black] py-[0.2rem] m-auto w-[70%] text-white text-center smScreenMax:w-[95%]";
  return (
    <div className="grid grid-rows-3 items-center m-0 bg-yellow-100/30 shadow-[0_0_5px_3px_black]">
      <div className={inputStyle}>
        <strong className="absolute smScreenMax:hidden top-[3px] left-[-1rem]  ">
          1
        </strong>
      ...
      <div className={inputStyle}>
        <strong className="smScreenMax:hidden absolute top-[3px] left-[-1rem]">
          3
        </strong>
